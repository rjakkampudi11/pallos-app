...
export function LegalShell({ eyebrow, title, lead, children }: { eyebrow: string; title: string; lead: string; children: ReactNode }) {
  return <main className="legal-site">
    ...
    <footer className="legal-footer"><div className="shell"><span>© 2026 Pallos Agent</span><nav><Link href="/guides/ai-code-security-checklist">Security guide</Link><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link><Link href="/cookies">Cookies</Link><a href="mailto:pallosagent@gmail.com">Email us</a></nav></div></footer>
  </main>;
}
