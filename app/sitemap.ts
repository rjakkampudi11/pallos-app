...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: "https://pallosagent.com/tools", lastModified, changeFrequency: "monthly", priority: 0.8 },
    { url: "https://pallosagent.com/tools/github-secret-scanner", lastModified, changeFrequency: "monthly", priority: 0.85 },
    { url: "https://pallosagent.com/tools/supabase-rls-checker", lastModified, changeFrequency: "monthly", priority: 0.85 },
    { url: "https://pallosagent.com/tools/nextjs-security-scanner", lastModified, changeFrequency: "monthly", priority: 0.85 },
