...
export default function Page() { return <LegalShell eyebrow="PRACTICAL GUIDE" title="AI code security checklist before launch" lead="Use this checklist after building with an AI coding tool and before connecting real customers, payments, or sensitive data.">
  ...
  <section><h2>What an automated scanner cannot prove</h2><p>No scanner can verify every business rule or guarantee an app is secure. Combine automated checks with manual role testing, backups, staging, monitoring, and professional review when the impact warrants it.</p><p><Link href="/methodology">See exactly what Pallos checks</Link> or <Link href="/#free-scan">try the public API check</Link>.</p></section>
</LegalShell>; }
