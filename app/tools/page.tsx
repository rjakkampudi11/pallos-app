...
export const metadata: Metadata = {
  title: "Free Code Security Tools | Pallos",
...
export default function ToolsPage() {
  return <main className="tool-page">
    <header className="tool-nav"><nav><Link href="/" className="tool-brand"><span />Pallos</Link><div><Link href="/proof">Proof Lab</Link><Link href="/scan" className="tool-nav-cta">Scan a repository</Link></div></nav></header>
