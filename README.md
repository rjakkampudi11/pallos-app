...
The API monitor, authentication, Supabase persistence, incident email delivery, daily checks, and deterministic read-only GitHub scanner are real V1 features. Supabase, Vercel, Stripe, agent-run, and demo project panels that are explicitly marked as demo remain placeholders. See `docs/supabase-monitor-setup.md` and `docs/github-app-setup.md` for setup.
